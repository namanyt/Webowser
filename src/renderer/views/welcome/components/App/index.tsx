...
const themeset = (mode: string) => {
  ...
  if (theme == "Light") {
    ...
    store.settings.theme = "webowser-blue";
    store.settings.themeAuto = false;
    store.save();
    ...
    store.settings.theme = "webowser-lavender";
    store.settings.themeAuto = false;
    store.save();
  }
}
  ...
  return (
    <ThemeProvider theme={{ ...store.theme }} style={{position: 'relative'}}>
      ...
      <StyledSection className="banner1">
        <Description>Welcome to Webowser Next</Description>
      ...
      <StyledSection className="banner2">
       ...
       <StyledSection className="banner3">
        ...
        <Description style={{fontSize: "1.5rem", fontWeight: 500, margin: 0, marginBottom: "48px", opacity: '1' }}>For maximum privacy, set Webowser as your default browser!</Description>
      ...
      <StyledSection className="banner4">
        <Description>Webowser is the personal Browser!</Description>
